...
class CPPGenerator:
    ...
    def write_autogen_warning(fout: TextIO):
        fout.write(
            f"// This file was generated by `ir_opcode_generator`.\n"
    ...
    def write_ir_opcodes(self, fout: TextIO):
        ...
        fout.write(
            ...
            f"}};\n"
            f"\n"
            f"constexpr std::array<{self._opcode_enum_name}, {opcode_count}> all_iropcodes_array = {{\n"
            f"\t#define X(iropcode) {self._opcode_enum_name}::iropcode,\n"
            f"\t{CPPGenerator.ALPHA_IR_OPCODES_MACRO}\n"
            f"\t#undef  X\n"
            f"}};\n"
            f"}} // namespace {CPPGenerator.IR_NAMESPACE}\n"
    ...
    def write_ir_opcode_to_string_impl(self, fout: TextIO):
        fout.write(
            ...
            f'#include <support/string_tools.hpp>\n'
            f"namespace {CPPGenerator.IR_NAMESPACE}\n"
            f"{{\n"
            ...
            f"\tswitch (opc)\n"
            f"\t{{\n"
            f"\t\t#define X(opc) case {self._opcode_enum_name}::opc: return support::tolower_str(#opc);\n"
            f"\t\t{CPPGenerator.ALPHA_IR_OPCODES_MACRO}\n"
            f"\t\t#undef  X\n"
            f"\t\tdefault:\n"
