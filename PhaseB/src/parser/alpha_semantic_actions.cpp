...
namespace // (Anonymous)
{
            ...
            ErrorTracker &et)
        {
                ...
                if (resolved_symbol->is_function())
                {
                        ...
                        et.report_error(
                            CTError::Type::SEMANTIC, error, id_location, note, resolved_symbol->location);
                }
            ...
            ErrorTracker &et)
        {
                ...
                et.report_error(
                    CTError::Type::SEMANTIC, error, id_location,
    ...
    ErrorTracker &et)
{
        ...
        if (lvalue->type == Symbol::Type::LIBFUNC)
        {
    ...
    ErrorTracker &et)
{
        if (!reported_function_name_conflict(st, parse_ctx.current_scope(), parse_ctx.last_function_id, parse_ctx.last_function_location, et))
                st.insert_function(parse_ctx.last_function_id, Symbol::Type::USERFUNC,
