...
#define CASE_ASSERT(...)                                                                           \
        ...
        case AET::ARITHMETIC_EXPR:
                CASE_ASSERT(has_symbol(e), has_loc(e), !has_index(e));
        case AET::ASSIGN_EXPR:
                CASE_ASSERT(has_symbol(e), has_loc(e), !has_index(e));
        case AET::BOOLEAN_EXPR:
                CASE_ASSERT(has_symbol(e), has_loc(e), !has_index(e));
        case AET::CONST_BOOL:
        ...
        case AET::TABLE_ITEM:
                CASE_ASSERT(has_symbol(e), has_loc(e), has_index(e));
        case AET::VARIABLE:
                CASE_ASSERT(has_symbol(e), !has_index(e));
        default:
...
std::string expr_printer(const Alpha::Expr *expr)
{
        ...
        {
        case AET::CONST_BOOL:
                return expr->const_bool ? "true" : "false";
        case AET::CONST_INT:
...
Driver::Driver(const std::string &source_filepath, bool show_parser_trace) :
    ...
    flex_buffer_(source_filepath), lt_(flex_buffer_.size() - k_flex_eof_padding), et_(), st_(),
    lexer_ctx_(source_filepath), parse_ctx_(st_, et_), sm_(parse_ctx_, st_, et_),
...
void Driver::run_alpha_parser() { parser_retval_ = alpha_yyparse(lt_, et_, lexer_ctx_, sm_, sb_); }
