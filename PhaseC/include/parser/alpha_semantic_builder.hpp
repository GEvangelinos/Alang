...
private:
        ...
        void validate_lvalue_for_assignment(const Symbol *lvalue_symbol, SourceLocation assign_loc);

        [[nodiscard]] Expr *handle_table_item_assignment(Expr *lvalue, Expr *expr,
                                                         SourceLocation assign_loc);

        [[nodiscard]] Expr *handle_direct_assignment(Expr *lvalue, Expr *expr, SourceLocation assign_loc);

        static void update_expr_location(Expr *expr, SourceLocation new_expr_loc);
