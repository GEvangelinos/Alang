...
const std::initializer_list<std::string> k_library_function_names = {"print",
                                                                     "input",
                                                                     "objectmemberkeys",
                                                                     "objecttotalmembers",
                                                                     "objectcopy",
...
public:
        ...
        const Symbol *insert_function(const std::string &symbol_name, Symbol::Type type, u32 scope,
                                      const std::list<Parameter> &param_list, Location location);
        const Symbol *insert_anonymous(u32 scope, Location location,
                                       const std::list<Parameter> &param_list);
        const Symbol *insert_variable(const std::string &symbol_name, u32 scope, u32 offset,
                                      Location location);
...
private:
        ...
        const Symbol *insert_symbol(SymbolKind &&new_symbol);
};
...
public:
        ...
        Variable(const std::string &name, u32 scope, ScopeSpace space, u32 offset,
                 Location location)
...
public:
        ...
        Function(const std::string &name, const u32 scope, const Symbol::Type type,
                 const std::list<Parameter> &param_list, const Location location)
            : Symbol(name, scope, type, location), param_list(param_list)
        {
