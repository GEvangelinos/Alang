...
public:
        ...
        [[nodiscard]] Expr *make_expr_assign(
            Expr *rvalue, Location assign_loc); // TODO: !! Why two make assign expr?
        [[nodiscard]] Expr *make_expr_assign(const Symbol *symbol,
                                             Location assign_loc); // TODO: WHy 2? make_assign_expr?
        ...
        [[nodiscard]] Expr *make_expr_table_item(Expr *&lvalue, const std::string &id,
                                                 Location id_loc, Location table_item_loc);
        [[nodiscard]] Expr *make_expr_table_item(Expr *&lvalue, Expr *expr, Location table_tem_Loc);
...
inline void FunctionCtxHandler::add_function_parameter(const std::string &name, Location loc)
{
...
inline void QuadHandler::emit_quad(const IOPCode iopc, const Expr *arg1, const Expr *arg2,
                                   const Expr *result, const Location loc)
{
...
inline void QuadHandler::emit_quad_labelless(IOPCode iopc, const Expr *arg1, const Expr *arg2,
                                             const Expr *result, Location loc)
{
...
inline void QuadHandler::emit_quad_impl(IOPCode iopc, const Expr *arg1, const Expr *arg2,
                                        const Expr *result, u32 label, Location loc)
{
...
inline Expr *ExprHandler::make_expr_variable(const Symbol *const symbol, Location var_loc)
{
...
inline Expr *ExprHandler::make_expr_const_string(const char *str_value, Location str_loc)
{
...
inline Expr *ExprHandler::make_expr_const_int(i64 int_value, Location int_loc)
{
...
inline Expr *ExprHandler::make_expr_const_real(f64 real_value, Location real_loc)
{
...
inline Expr *ExprHandler::make_expr_const_bool(bool bool_value, Location bool_loc)
{
...
inline Expr *ExprHandler::make_expr_const_nil(Location nil_loc)
{
...
inline Expr *ExprHandler::make_expr_table_item(Expr *&lvalue, const std::string &id,
                                               Location id_loc, Location table_item_loc)
{
...
inline Expr *ExprHandler::make_expr_table_item(Expr *&lvalue, Expr *expr,
                                               const Location table_item_loc)
{
...
inline Expr *ExprHandler::make_expr_new_table(const Location new_table_loc)
{
...
inline Expr *ExprHandler::make_expr_arithmetic(Location arithmetic_loc)
{
...
inline Expr *ExprHandler::make_expr_boolean(Location bool_expr_loc)
{
...
inline Expr *ExprHandler::make_expr_assign(const Symbol *symbol, Location assign_loc)
{
        DEBUG_SMART_ASSERT(!!symbol);
...
// TODO 2: DONT MAKE THE SAME NAME make_expr functions (AKA DONT OVERLOAD THEM...)!!! (VERY BAD
// DESIGN (BOMB WAITING TO EXPLODE!!!!))
inline Expr *ExprHandler::make_expr_assign(Expr *rvalue, Location assign_loc)
{
...
inline const Symbol *ParseCtx::new_temp()
{
        ...
        if (!symbol)
        {
                Variable::Type var_type = scope_handler.scope() == k_global_scope
                                              ? Variable::Type::GLOBAL_VARIABLE
                                              : Variable::Type::LOCAL_VARIABLE;

                symbol = st_.insert_variable(temp_name, scope_handler.scope(), var_type,
                                             space_handler.space(), space_handler.next_offset(),
                                             k_no_location //
