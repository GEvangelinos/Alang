...
inline void FunctionCtxHandler::enter_function(const Function *function_symbol, const u32 label_of_jump)
{
#ifdef DEBUG_MODE
...
inline bool QuadHandler::requires_label(const IOPCode iopc) noexcept
{
        switch(iopc)
        {
...
inline Expr *ExprHandler::make_expr_variable(const Symbol *const symbol, SourceLocation var_loc)
{
...
inline Expr *ExprHandler::make_expr_const_string(const char *str_value, SourceLocation str_loc)
{
...
inline Expr *ExprHandler::make_expr_const_int(i64 int_value, SourceLocation int_loc)
{
...
inline Expr *ExprHandler::make_expr_const_real(f64 real_value, SourceLocation real_loc)
{
...
inline Expr *ExprHandler::make_expr_const_bool(bool bool_value, SourceLocation bool_loc)
{
...
inline Expr *ExprHandler::make_expr_const_nil(SourceLocation nil_loc)
{
...
inline Expr *ExprHandler::make_expr_table_item(Expr *&lvalue, Expr *expr,
                                               const SourceLocation table_item_loc)
{
...
inline Expr *ExprHandler::make_expr_new_table(const SourceLocation new_table_loc)
{
...
inline Expr *ExprHandler::make_expr_arithmetic(SourceLocation arithmetic_loc)
{
...
inline Expr *ExprHandler::make_expr_boolean(SourceLocation bool_expr_loc)
{
...
inline Expr *ExprHandler::make_expr_assign(const Symbol *symbol, SourceLocation assign_loc)
{
        DEBUG_SMART_ASSERT(!!symbol);
...
inline Expr *ExprHandler::make_expr_assign(const Expr *const rvalue, const SourceLocation assign_loc)
{
